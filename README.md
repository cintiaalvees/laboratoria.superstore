...
📄 [Versão PDF estática](dashboard_superstore.pdf)
...
A apresentação completa com contexto, análises e recomendações está disponível em ([`docs/ficha_tecnica_superstore.pdf`](ficha_tecnica_superstore.pdf)).
